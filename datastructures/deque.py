...
class Deque[T](IQueue[T]):
    ...
    def __eq__(self, other:Deque) -> bool:
        ...
        if len(self) != len(other):
            return False
        elif not isinstance(other, Deque):
            return False
        else:
            scopy = copy.deepcopy(self)
            ocopy = copy.deepcopy(other)
            for _ in range(len(self)):
                if scopy.dequeue() != ocopy.dequeue():
                    return False
            return True
    ...
    def __str__(self) -> str:
        ...
        """
        return str([i for i in self.__list])
    ...
    def __repr__(self) -> str:
        ...
        """
        return f"Deque {str(self)}, data type {self.__data_type}"
